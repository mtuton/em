...
.method public parse(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/apache/james/mime4j/field/Field;
    ...
    .line 240
    .local v12, paramNames:Ljava/util/ArrayList;
    ...
    .line 242
    .local v14, paramValues:Ljava/util/ArrayList;
    if-eqz v12, :cond_2
    ...
    .end local p0
    .local v15, parameters:Ljava/util/Map;
    :goto_1
    :try_start_2
    ...
    .line 246
    .end local v15           #parameters:Ljava/util/Map;
    ...
    .end local v7           #parameters:Ljava/util/Map;
    .restart local v15       #parameters:Ljava/util/Map;
    goto :goto_1

    .line 219
    .end local v10           #i:I
    .end local v11           #paramName:Ljava/lang/String;
    .end local v12           #paramNames:Ljava/util/ArrayList;
    .end local v13           #paramValue:Ljava/lang/String;
    .end local v14           #paramValues:Ljava/util/ArrayList;
    .end local v15           #parameters:Ljava/util/Map;
    ...
    .restart local v12       #paramNames:Ljava/util/ArrayList;
    .restart local v14       #paramValues:Ljava/util/ArrayList;
    .restart local v15       #parameters:Ljava/util/Map;
